...
public class ProductoBeanUI implements Serializable {
    ...
    public Producto.UnidadMedida getUnidadMedida() {
        return unidadMedida;
    }

    public void setUnidadMedida(Producto.UnidadMedida unidadMedida) {
    ...
    public LocalDate getFechaCaducidadLote() {
        return fechaCaducidadLote;
    }

    public void setFechaCaducidadLote(LocalDate fechaCaducidadLote) {
